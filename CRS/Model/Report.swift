...
struct ReportPM: Codable {
    let customerID, customerName, customerPotential, customerPrescription: String
    let specialityName, serial, product1_ID, product2_ID: String
    let product3_ID, product4_ID, fManagerDv, mManagerDv: String
    let hManagerDv, visitComment, visitingDayDate, pIDS: String
    let pNames, pSpecialities, pMobiles, pComments: String
    let dvReport: String
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case pIDS = "p_ids"
        case pNames = "p_names"
        case pSpecialities = "p_specialities"
        case pMobiles = "p_mobiles"
    ...
    init(from decoder: Decoder) throws {
        ...
        pMobiles = try values.decodeIfPresent(String.self, forKey: .pMobiles) ?? ""
        pSpecialities = try values.decodeIfPresent(String.self, forKey: .pSpecialities) ?? ""
